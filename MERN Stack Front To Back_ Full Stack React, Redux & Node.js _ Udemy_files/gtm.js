...
"resource": {
  ...
  "rules":[
    [["if",0,3],["unless",1,2],["add",3,70]],
    [["if",6,7],["add",4,8,9,10,14,19,20,24,27,28,29,31,34,35,38,41,43,45,66,86,87,92,93,99,102,105]],
    [["if",4,5],["add",5],["block",3,7,16,37,39,42,71,1,76,81,84,88,2,94,95,97,100,103]],
    [["if",5],["add",5,16,46,76,100,103,47,48,50,51,52,56,59,60,64,65,68]],
    [["if",5,9],["unless",8],["add",6,15]],
    [["if",10,11],["add",7]],
    [["if",5,12],["add",11,79]],
    [["if",13,14,15],["add",12,80]],
    [["if",5,16],["add",13,23,26]],
    [["if",5,17],["add",15]],
    [["if",5,18],["add",15]],
    [["if",5,19],["add",15],["block",81]],
    [["if",5,17,20],["add",15]],
    [["if",5,21],["add",15]],
    [["if",5,22],["add",15]],
    [["if",5,23],["add",15]],
    [["if",5,24],["add",15]],
    [["if",5,25],["add",15]],
    [["if",15,30],["add",17,31,33,74,91]],
    [["if",15,31],["add",18]],
    [["if",5,32],["add",21]],
    [["if",33],["add",22]],
    [["if",5,34],["add",25,31,32,36,38,40,44,77,90,98,101,104]],
    [["if",5,35],["add",30]],
    [["if",5,36],["add",30]],
    [["if",5,37],["add",30]],
    [["if",0,5,38],["add",37,39,84,94,97]],
    [["if",0,5],["unless",1,39],["add",42,58,81,88,0]],
    [["if",5,40],["add",49]],
    [["if",42],["unless",41],["add",53,61]],
    [["if",3],["unless",43],["add",54,62]],
    [["if",3],["add",55,63]],
    [["if",3,44],["add",57]],
    [["if",3,45],["add",67,69]],
    [["if",5,26],["add",71],["block",16,81,89,96,100,103]],
    [["if",5,46],["unless",47],["add",71]],
    [["if",48,49],["add",71]],
    [["if",5,51],["add",1]],
    [["if",53,54],["add",72]],
    [["if",3,55],["add",73]],
    ...
    [["if",6,58],["add",78]],
    [["if",6,7,38],["add",82,83]],
    [["if",61,62,63,64],["add",85]],
    [["if",62,64],["add",89]],
    [["if",53,65],["add",2]],
    [["if",53,66],["add",95]],
    [["if",53,67],["add",96]],
    [["if",5,68],["add",106,107,108]],
    [["if",6,7,68],["add",108]],
    [["if",3,55,68],["add",109]],
    [["if",15,30,68],["add",110]],
    [["if",53,68,69],["add",111]],
    [["if",13,14,15,68],["add",112]],
    [["if",5,34,68],["add",113]],
    [["if",5,27],["block",16,81,89,96,100,103]],
    [["if",5,28],["block",16,81,89,96,100,103]],
    [["if",5,29],["block",16,81,89,96,100,103]],
    [["if",5,39],["block",71,1]],
    [["if",5,50],["block",71]],
    [["if",5,52],["block",1]],
    [["if",5,59],["block",81]],
...
w,v);else{var F=r.vtp_attribute,M=a(u,"element");D=M&&fg(M,F)||v||""}return D;case "MD":var Q=r.vtp_mdValue,ca=b(u,"MD",Xp);return Q&&ca?$p(ca,Q)||v:ca||v;case "FORM":return f(String(r.vtp_component||"SUBMIT_TEXT"),u,v);default:var ea=c(u,w,v);rq(ea,"aev",r.vtp_gtmEventId);return ea}})}();
